...
--
-- Table structure for table `0009_banner`
--

CREATE TABLE `0009_banner` (
...
--
-- Dumping data for table `0009_banner`
--

INSERT INTO `0009_banner` (`id`, `name`, `link`, `position`, `image`, `sort_order`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0009_brand`
--

CREATE TABLE `0009_brand` (
...
--
-- Dumping data for table `0009_brand`
--

INSERT INTO `0009_brand` (`id`, `name`, `slug`, `sort_order`, `image`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0009_category`
--

CREATE TABLE `0009_category` (
  `id` int NOT NULL COMMENT 'Mã Loại',
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Tên loại SP',
  `slug` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'SLug Loại SP',
...
--
-- Dumping data for table `0009_category`
--

INSERT INTO `0009_category` (`id`, `name`, `slug`, `parent_id`, `sort_order`, `image`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0009_contact`
--

CREATE TABLE `0009_contact` (
...
--
-- Table structure for table `0009_menu`
--

CREATE TABLE `0009_menu` (
...
--
-- Dumping data for table `0009_menu`
--

INSERT INTO `0009_menu` (`id`, `name`, `link`, `type`, `table_id`, `sort_order`, `position`, `level`, `parent_id`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0009_order`
--

CREATE TABLE `0009_order` (
...
--
-- Table structure for table `0009_orderdetail`
--

CREATE TABLE `0009_orderdetail` (
...
--
-- Table structure for table `0009_post`
--

CREATE TABLE `0009_post` (
...
--
-- Table structure for table `0009_product`
--

CREATE TABLE `0009_product` (
...
--
-- Dumping data for table `0009_product`
--

INSERT INTO `0009_product` (`id`, `category_id`, `brand_id`, `name`, `slug`, `image`, `detail`, `qty`, `price`, `pricesale`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0009_topic`
--

CREATE TABLE `0009_topic` (
...
--
-- Table structure for table `0009_user`
--

CREATE TABLE `0009_user` (
...
--
-- Dumping data for table `0009_user`
--

INSERT INTO `0009_user` (`id`, `name`, `username`, `password`, `email`, `gender`, `phone`, `image`, `roles`, `address`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Indexes for table `0009_banner`
--
ALTER TABLE `0009_banner`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0009_brand`
--
ALTER TABLE `0009_brand`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0009_category`
--
ALTER TABLE `0009_category`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0009_contact`
--
ALTER TABLE `0009_contact`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0009_menu`
--
ALTER TABLE `0009_menu`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0009_order`
--
ALTER TABLE `0009_order`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0009_orderdetail`
--
ALTER TABLE `0009_orderdetail`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0009_post`
--
ALTER TABLE `0009_post`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0009_product`
--
ALTER TABLE `0009_product`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0009_topic`
--
ALTER TABLE `0009_topic`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0009_user`
--
ALTER TABLE `0009_user`
  ADD PRIMARY KEY (`id`) USING BTREE;
