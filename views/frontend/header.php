   ...
   <section class="hdl-header">
      ...
      <div class="row">
         <div class="col-6 col-sm-6 col-md-2 py-1">
            <a href="index.php">
               <img height="150px" width="300px" src="Public/images/Logo01.png" alt="Logo">
            </a>
         </div>
            ...
            <div class="call-login--register border-bottom">
               <ul class="nav nav-fills py-0 my-0">
                  ...
                  <?php if (isset($_SESSION['name'])) : ?>
                     <li class="nav-item">
                        <a class="nav-link" href="index.php?option=profile">
                           Tên Khách Hàng:<?php echo $_SESSION['name']; ?></a>
                     </li>
                     <li class="nav-item">
                  ...
                  <?php else : ?>
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="index.php?option=customer&register=true">Hồ Ngọc Minh Trí</a>
                     </li>
