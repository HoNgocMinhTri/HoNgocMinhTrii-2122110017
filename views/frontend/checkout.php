...
<section class="hdl-maincontent py-2">
   <div class="container">
      <div class="row">
         <div class="col-md-6">
            <form actiion="index.php?option=checkout" method="post">
               <h2 class="fs-5 text-main">Thông tin giao hàng</h2>

               <?php if (isset($_SESSION["iscumtom"])) : ?>
                  <div class="mb-3">
                     <label for="name">Họ tên</label>
                     <input type="text" name="name" id="name" readonLy value="<?= $customer->name; ?>" class="form-control" placeholder="Nhập họ tên">
                  </div>
                  <div class="mb-3">
                     <label for="phone">Điện thoại</label>
                     <input type="text" name="phone" id="phone" value="<?= $customer->phone; ?>" readonLy class="form-control" placeholder="Nhập điện thoại">
                  </div>
                  <div class="mb-3">
                     <label for="phone">Email</label>
                     <input type="text" name="email" id="email" value="<?= $customer->email; ?>" readonLy class="form-control" placeholder="Nhập điện thoại">
                  </div>
                  <div class="card-body">
                     <div class="mb-3">
                        <label for="address">Địa chỉ</label>
                        <input type="text" name="address" id="address" readonLy value="<?= $customer->address; ?> " class="form-control" placeholder="Nhập địa chỉ">
                     </div>
                  </div>
                  ...
                  <div class="thanhtoan mb-4">
                     ...
                     <div class="p-4 border bankinfo">
                        ...
                        <p>Chủ tài khoản: Huỳnh Duy Khánh</p>
                     </div>
                  </div>
                  <div class="text-end">
         ...
         <?php else : ?>
            ...
            <a href="index.php?option=customer&register=true">Đăng ký</a></p>
         <?php endif; ?>
         ...
         <div class="col-md-6">
            ...
            <table class="table table-borderless">
               <tr>
                  <th>Tạm tính</th>
                  <td class="text-end"><?= number_format(Cart::cartTotal()); ?></strong></td>
               </tr>
               <tr>
