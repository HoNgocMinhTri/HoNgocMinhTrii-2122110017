...
<div class="user-panel mt-3 pb-3 mb-3 d-flex">
               <div class="image">
                  <img src="../public/images/user/minti.jpg" class="img-circle elevation-2" alt="User Image">
               </div>
               <div class="info">
                  <a href="#" class="d-block">Minh Trí</a>
               </div>
            </div>
            <nav class="mt-2">
...
<a href="index.php?option=page" class="nav-link">
                  ...
                  <li class="nav-item">
                     ...
                     <ul class="nav nav-treeview">
                        <li class="nav-item">
                           <a href="index.php?option=menul" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Menu</p>
                           </a>
                        </li>
